...
export default class Login extends Component {
  ...
  {/* <KeyboardAvoidingView style={{width:deviceWidth,height:deviceHeight,enabled:true,keyboardVerticalOffset:-100}}>
...
// justifyContent: "flex-end"
          <View style={{ backgroundColor: '#FFFFFF', flex: 1, flexDirection: 'column'}}>  
            <View style={{width:deviceWidth, height:deviceHeight*0.1, backgroundColor: "#CCCCCC" }}>
              <Header style={{ backgroundColor: '#CCCCCC' }}
                androidStatusBarColor="#CCCCCC">
